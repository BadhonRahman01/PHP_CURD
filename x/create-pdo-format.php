...
// echo $input_lat;
    ...
    if(empty($store_id_err) && empty($branch_name_err) && empty($branch_location_err) && empty($phone_err) && empty($lat_err) && empty($long_err)){
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            $stmt->bindParam(":store_id", $param_store_id);
            $stmt->bindParam(":branch_name", $param_branch_name);
            $stmt->bindParam(":branch_location", $param_branch_location);
            $stmt->bindParam(":phone", $param_phone);
            $stmt->bindParam(":lat", $param_lat);
            $stmt->bindParam(":long", $param_long);
